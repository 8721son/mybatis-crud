...
- create user 'won'@'%' identified by 'bitc5600';
...
CREATE TABLE user(
    ...
    email varchar(100), 
    userProfile varchar(200) default '/images/man.jpg',
...
spring:
  ...
  datasource:
    ...
    url: jdbc:mysql://localhost:3306/won?serverTimezone=Asia/Seoul&useSSL=false&allowPublicKeyRetrieval=true
    username: won
    password: bitc5600
